...
<div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <div class="tx-center mg-b-40">The Admin Panel For Movie Review System</div>
        <form method="POST" action="{{ route('register') }}">
            ...
            <x-text-input id="role" class="form-control" placeholder="Enter role" type="hidden" name="role" :value="1" required />
        ...
        <div class="mg-t-40 tx-center">Already a member? <a href="{{ route('login') }}" class="tx-info">Log In</a></div>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
